...
import RestaurantListingComponent from '../components/Restaurants/Listing';
import RestaurantSingleComponent from '../components/Restaurants/Single';
...
const Index = (
  <Stack hideNavBar>
    <Scene hideNavBar>
      ...
      >
        ...
        <Stack
          ...
          {...DefaultProps.navbarProps}
        >
          <Scene key="recipes" component={RestaurantsContainer} Layout={RestaurantListingComponent} />
        </Stack>
    ...
    <Scene
      ...
      Layout={RestaurantSingleComponent}
    />
  </Stack>
);
